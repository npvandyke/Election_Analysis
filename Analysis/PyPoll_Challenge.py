...
# 1. county options and votes per county.
county_options = []
county_votes = {}

#2. Track the county with the highest turnout, county vote count
#  and percentage of total votes 
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        # 4. If the county does not match any existing county, add it to
        # the county_options list
